...
<main class="flex justify-center leading-7">
	<Container class="grid gap-4 p-4">
		...
		{' '}
		<p>
			Built the isave app as a Free app. This SERVICE is provided by at no cost and is intended for
			use as is.
		</p>
		{' '}
		<p>
		...
		<p>
			...
			which are accessible at isave unless otherwise defined in this Privacy Policy.
		</p>
		{' '}
		<p>
		...
		<div>
			<p>
				...
				and/or Services. I encourage parents and legal guardians to monitor their children Internet
				...
				information to us through the Application and/or Services, please contact us. You must also
				be at least 16 years of age to consent to the processing of your personally identifiable
		...
		<p>
			...
			me you can get my contact information from{' '}
