...
export const metadata = {
  title: "Privacy Policy - isave",
  description: "Privacy Policy of isave",
};

function PrivacyPolicyPage() {
  return (
    <main className="flex justify-center leading-7">
      <Container className="grid gap-4 p-4">
        <h1>Privacy Policy</h1>{" "}
        <p>
          Built the isave app as a Free app. This SERVICE is provided by at no
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at isave unless otherwise
